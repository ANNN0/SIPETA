        ...
        <section class="shop-checkout container">
            ...
            <div class="order-complete">
                <div class="order-complete__message">
                    ...
                    <a href="{{ route('user.orders') }}" class="btn-check-orders mt-3">
                ...
                {{-- Alamat Pengiriman Details - Table Format --}}
                    ...
                    <div class="checkout__totals">
                        ...
                        <table class="checkout-cart-items">
                            ...
                            <tbody>
                                @foreach ($order->orderItems as $item)
                                    <tr>
                                        <td>
                                            {{ $item->product->name }} x {{ $item->quantity }} @if ($item->unit_symbol)
                        ...
                        <table class="checkout-totals">
                            <tbody>
                                ...
                                <tr class="organic-summary">
                                    <th>Produk Organik</th>
                                    <td class="text-right">Rp {{ number_format($organicSubtotal, 0, ',', '.') }}</td>
                                </tr>
                                <tr class="non-organic-summary">
                                    <th>Produk Non-Organik</th>
                                    <td class="text-right">Rp {{ number_format($nonOrganicSubtotal, 0, ',', '.') }}</td>
                                </tr>
                                <tr>
                                    <th>DISKON</th>
