...
@section('content')
    <main class="pt-90">
        ...
        <section class="my-account container">
            {{-- Breadcrumb --}}
            @include('user.components.breadcrumb', ['currentPage' => 'Edit Alamat'])

            {{-- Page Title --}}
            <h2 class="title-user__page">Edit Alamat</h2>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-10">
                                <div class="d-flex justify-content-between align-items-end mb-3">
                                    <p class="notice mb-0">Perbarui rincian alamat pengiriman Anda</p>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-floating mb-3">
                                                        <input type="text"
                                                            ...
                                                            name="zip" id="zip"
                                                            value="{{ old('zip', $address->zip) }}" placeholder="Kode Pos"
                                                            required>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="address-form-actions">
                                                        <button type="submit" class="btn btn-primary btn-update">
                                                            <i class="fa fa-save me-2"></i>Perbarui Alamat
                                                        </button>
