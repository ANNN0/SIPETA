        ...
        <div class="main-content-wrap">
            ...
            <div class="wg-box">
                <form class="form-new-product form-style-1" method="POST" action="{{ route('admin.coupon.store') }}">
                    ...
                    <fieldset class="name">
                        <div class="body-title">Tanggal Kedaluwarsa <span class="tf-color-1">*</span></div>
                        <input class="flex-grow" type="date" placeholder="Tanggal Kedaluwarsa" name="expiry_date" tabindex="0"
