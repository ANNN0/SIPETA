        ...
        <div class="main-content-wrap">
            <div class="flex items-center flex-wrap justify-between gap20 mb-27">
                ...
                <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                    ...
                    <li>
                        <div class="text-tiny">New Slide Split</div>
                    </li>
                </ul>
            </div>
            <!-- new-slide-split -->
            ...
            @endif
            <div class="wg-box">
                <form class="form-new-product form-style-1" action="{{ route('admin.slide.split.store') }}" method="POST"
                    ...
                    <fieldset class="name">
                        ...
                        <textarea class="flex-grow" placeholder="Subtitle (optional)" name="subtitle" tabindex="0" rows="3">{{ old('subtitle') }}</textarea>
                    </fieldset>
                    @error('subtitle')
                        <span class="alert alert-danger text-center">{{ $message }}</span>
                    @enderror
                    ...
                    <fieldset class="name">
                        ...
                        <div class="d-flex gap-3 align-items-center">
                            <input class="flex-grow" type="color" name="background_color"
                                value="{{ old('background_color', '#e8f5e9') }}" required>
                            <input class="form-control" type="text" name="background_color_hex" id="colorHex"
                                value="{{ old('background_color', '#e8f5e9') }}" pattern="^#[a-fA-F0-9]{6}$"
                                placeholder="#e8f5e9" style="max-width: 120px;">
                        </div>
                    ...
                    <fieldset>
                        <div class="body-title">Background Image <span class="tf-color-1">*</span>
                        </div>
                        ...
                        <small class="text-muted">Max file size: 10MB (jpeg, png, jpg, gif, webp) | Recommended: 3840x2160
                            (4K)</small>
                    </fieldset>
