        ...
        <div class="main-content-wrap">
            ...
            <div class="wg-box">
                        ...
                        <table class="table table-striped table-bordered">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Image</th>
                                    <th>Subtitle Kecil</th>
                                    <th>Judul Utama</th>
                                    <th>Subtitle Besar</th>
                                    <th>Link</th>
                                    <th>Aksi</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($slides as $slide)
                                    <tr>
                                        ...
                                        <td>{{ $slide->subtitle_small }}</td>
                                        <td>{{ $slide->title_main }}</td>
                                        <td>{{ $slide->subtitle_large }}</td>
                                        <td class="link-cell">{{ $slide->link }}</td>
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <a class="dropdown-item"
                                                            href="{{ route('admin.slide.edit', $slide->id) }}">
                                                            Edit
                                                        </a>
                                                    </li>
                                                    <li>
                                                    ...
                                                    <li>
                                                        <a href="javascript:void(0)"
                                                            ...
                                                            data-name="{{ $slide->title_main }}" data-type="Slide"
                                                            data-action="{{ route('admin.slide.delete', $slide->id) }}">
                                                            Delete
                                                        </a>
                                                    </li>
                                                </ul>
                ...
                <div class="flex items-center justify-between flex-wrap gap10 wgp-pagination">
                    <x-table-pagination :paginator="$slides" />
                </div>
            </div>
        </div>
    </div>
