        ...
        <div class="main-content-wrap">
            ...
            <div class="wg-box">
                <div class="flex items-center justify-between gap10 flex-wrap">
                    <div class="wg-filter flex-grow">
                        <form class="form-search">
                            <fieldset class="name">
                                <input type="text" placeholder="Cari petani..." name="name" tabindex="2"
                    ...
                    <a class="tf-button style-1 w208" href="{{ route('admin.farmer.add') }}">
                            ...
                            @foreach ($farmers as $farmer)
                                <tr>
                                    ...
                                    <td>
                                        @if ($farmer->photo)
                                            <div class="d-flex align-items-center justify-content-center">
                                                ...
                                                <div>
                                                    <div class="fw-medium">{{ $farmer->name }}</div>
                                                    <div class="text-muted small">{{ $farmer->slug }}</div>
                                                </div>
                                            </div>
                                        @else
                                            <div>
                                    ...
                                    <td>
                                        ...
                                        @endif
                                        @if ($farmer->email)
                                            <div class="text-tiny mt5">{{ $farmer->email }}</div>
                                        @endif
                                    </td>
                                    <td><a href="#">{{ $farmer->products_count }}</a></td>
                                    <td>
                                        @if ($farmer->is_active)
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li>
                                                    <a class="dropdown-item"
                                                        href="{{ route('admin.farmer.edit', ['id' => $farmer->id]) }}">Edit</a>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <a href="javascript:void(0)"
                                                        ...
                                                        data-name="{{ $farmer->name }}" data-type="Farmer"
                                                        data-action="{{ route('admin.farmer.delete', ['id' => $farmer->id]) }}">
                                                        Delete
                                                    </a>
                                                </li>
                                            </ul>
                ...
                <div class="flex items-center justify-between flex-wrap gap10 wgp-pagination">
                    <x-table-pagination :paginator="$farmers" />
                </div>
            </div>
        </div>
    </div>
